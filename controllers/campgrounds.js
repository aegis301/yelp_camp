...
const mapBoxToken = process.env.MAPBOX_TOKEN; // make access token available
const geocoder = mbxGeocoding({ accessToken: mapBoxToken }); // pass token into mapbox instantiation
